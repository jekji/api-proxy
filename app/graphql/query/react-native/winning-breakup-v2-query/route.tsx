...

{
	...
	"variables": {
		...
		"tourId": 5388,
		"matchId": 113033,
		"contestId": "9320242401",
		"slotTypes": ["CONTEST_DETAIL_BANNER", "CONTEST_DETAIL_FIRST_PRIZE", "CONTEST_CARD_PRE_RL", "INTL_CONTEST_CARD_PRE_RL"],
		"shouldFetchCampaignSlot": true
	}
}
...
export async function POST(request: Request) {
	...
	if (process.env.WWW_GRAPHAL_URL) {
		...
		try {
			const apiURL = process.env.WWW_GRAPHAL_URL + "/graphql/query/react-native/winning-breakup-v2-query";
			...
			console.log("winningBreakupV2Query", JSON.stringify(data));
