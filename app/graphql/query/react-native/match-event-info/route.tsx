...
/**
:method: POST
:path: /graphql/query/react-native/match-event-info
...
{"query":"\n    query MatchEventInfo($matchId: Int!) {\n  leaderboardLatestEventId(roundId: $matchId)\n}\n    ","variables":{"matchId":112970}}
*/
export async function POST() {
	return NextResponse.json({
		"data": {
			"leaderboardLatestEventId": 176
		}
	});
}
