...
/**
:method: POST
:path: /graphql/query/react-native/round-message-query
...
export async function POST(request: Request) {
	...
	if (process.env.WWW_GRAPHAL_URL) {
		...
		try {
			const apiURL = process.env.WWW_GRAPHAL_URL + "/graphql/query/react-native/round-message-query";
			...
			console.log("round-message-query", data);
