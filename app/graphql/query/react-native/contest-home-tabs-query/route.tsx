...
/**
:method: POST
:path: /graphql/query/react-native/contest-home-post-rl-base-query
...
{"query":"\n    query ContestHomePostRLBaseQuery($site: String!, $matchId: Int!, $shouldFetchSquads: Boolean = false) {\n  match(site: $site, id: $matchId) {\n    name\n    userTeamsCount\n    joinedContestsCount\n    joinedContestsMoreThanPageSize\n    status\n    startTime\n    squads @include(if: $shouldFetchSquads) {\n      shortName\n    }\n  }\n}\n    ","variables":{"matchId":112970,"site":"cricket","shouldFetchSquads":true}}
...
export async function POST(request: Request) {
	...
	if (process.env.WWW_GRAPHAL_URL) {
		...
		try {
			const apiURL = process.env.WWW_GRAPHAL_URL + "/graphql/query/react-native/contest-home-tabs-query";
			...
			console.log("contestHomeTabsQuery", JSON.stringify(data));
	...
	return NextResponse.json({
		"data": {
			"match": {
				"name": "KSO vs RRP",
				"userTeamsCount": 1,
				"joinedContestsCount": 1,
				"joinedContestsMoreThanPageSize": false,
				"status": "IN_PROGRESS",
