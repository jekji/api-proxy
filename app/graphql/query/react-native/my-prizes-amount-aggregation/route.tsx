...
/**
:method: POST
:path: /graphql/query/react-native/my-prizes-amount-aggregation
...
{
	"query": "\n    query MyPrizesAmountAggregation($entitlementId: Int!, $apiVersion: MyPrizesApiVersionV2!, $sourceId: [Int!]) {\n  myPrizesAmountAggregation(\n    entitlementId: $entitlementId\n    apiVersion: $apiVersion\n    sourceId: $sourceId\n  ) {\n    breakdownByEntitlement {\n      entitlementId\n      unclaimedAmount {\n        amount\n        currency\n        symbol\n      }\n    }\n  }\n}\n    ",
	"variables": {
		"apiVersion": "V2",
		"entitlementId": 1,
		"sourceId": [1]
...
export async function POST(request: Request) {
	...
	if (process.env.WWW_GRAPHAL_URL) {
		...
		try {
			const apiURL = process.env.WWW_GRAPHAL_URL + "/graphql/query/react-native/my-prizes-amount-aggregation";
			...
			console.log("my-prizes-amount-aggregation", JSON.stringify(data));
