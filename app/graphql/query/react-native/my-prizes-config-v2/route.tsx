...
/**
:method: POST
:path: /graphql/query/react-native/my-prizes-config-v2
...
{
	"query": "\n    query MyPrizesConfigV2($apiVersion: MyPrizesApiVersionV2!) {\n  myPrizesConfigV2(apiVersion: $apiVersion) {\n    entitlementIds\n    sourceIds\n    entitlementConfig {\n      entitlementId\n      threshold {\n        minClaimAmount {\n          amount\n          currency\n          symbol\n        }\n      }\n    }\n    automationFlags {\n      verification {\n        kycAutomated\n      }\n      claim {\n        paypalAutomated\n        bankAutomated\n      }\n    }\n    claimFlags {\n      kycAutomated\n    }\n  }\n}\n    ",
	"variables": {
		"apiVersion": "V2"
	}
}
...
export async function POST(request: Request) {
	...
	if (process.env.WWW_GRAPHAL_URL) {
		...
		try {
			const apiURL = process.env.WWW_GRAPHAL_URL + "/graphql/query/react-native/my-prizes-config-v2";
			...
			console.log("my-prizes-config-v2", JSON.stringify(data));
