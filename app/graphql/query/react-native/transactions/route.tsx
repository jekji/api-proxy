...
/**
:method: POST
:path: /graphql/query/react-native/transactions
...
{
	"query": "\n    query TRANSACTIONS_LIST($bucket: String!, $filters: [TransactionFilterInput], $after: String, $limit: Int!, $sort: Sort) {\n  getListOfTransactionsV2(\n    bucket: $bucket\n    limit: $limit\n    after: $after\n    sort: $sort\n    filters: $filters\n  ) {\n    cursor\n    hasNext\n    headerMessage\n    transactions {\n      id\n      isExpired\n      transactionId\n      createdAt {\n        date\n        isoString\n        time\n      }\n      type\n      displayName\n      amount {\n        amount\n        code\n        symbol\n      }\n      transTypeIcon\n      transactionIcon\n      transactionMeta\n      transType\n      contestId\n      tourId\n      roundId\n      site\n      status {\n        name\n        displayName\n      }\n      strikedAmount {\n        amount\n        currencySymbol\n      }\n      dreamCoinsMeta {\n        subText1\n        subText2\n      }\n      tooltipInfo {\n        tooltipTag\n        tooltipText\n      }\n      displayTag\n    }\n  }\n}\n    ",
	"variables": {
		"bucket": "withdrawal",
		"limit": 25,
		"sort": null,
...
export async function POST(request: Request) {
	...
	if (process.env.WWW_GRAPHAL_URL) {
		...
		try {
			const apiURL = process.env.WWW_GRAPHAL_URL + "/graphql/query/react-native/transactions";
	...
	return NextResponse.json({
		"data": {
			"getListOfTransactionsV2": {
				"cursor": "eyJzb3VyY2VDdXJzb3JNYXAiOnt9fQ==",
				"hasNext": false,
				"headerMessage": null,
				"transactions": []
			}
