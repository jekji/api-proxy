...
/**
:method: POST
:path: /graphql/query/react-native/shme-contest-home-footer-team-count-query
...
export async function POST(request: Request) {
	...
	if (process.env.WWW_GRAPHAL_URL) {
		...
		try {
			const apiURL = process.env.WWW_GRAPHAL_URL + "/graphql/query/react-native/shme-contest-home-footer-team-count-query";
			...
			console.log("shmeContestHomeFooterTeamCountQuery", JSON.stringify(data));
