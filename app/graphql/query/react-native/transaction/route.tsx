...
/**
:method: POST
:path: /graphql/query/react-native/transaction
...
{
	"query": "\n    query TRANSACTION_BUCKETS($shouldShowDc: Boolean!) {\n  getTransactionBucketsV2(shouldShowDC: $shouldShowDc) {\n    displayName\n    displayOrder\n    id\n    name\n  }\n}\n    ",
	"variables": {
		"shouldShowDc": false
	}
}
...
export async function POST(request: Request) {
	...
	if (process.env.WWW_GRAPHAL_URL) {
		...
		try {
			const apiURL = process.env.WWW_GRAPHAL_URL + "/graphql/query/react-native/transaction";
