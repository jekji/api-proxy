...
/**
:method: POST
:path: /graphql/query/react-native/get-leaderboard-latest-event-info
...
export async function POST(request: Request) {
	...
	if (process.env.WWW_GRAPHAL_URL) {
		...
		try {
			const apiURL = process.env.WWW_GRAPHAL_URL + "/graphql/query/react-native/get-leaderboard-latest-event-info";
			...
			console.log("get-leaderboard-latest-event-info", data);
