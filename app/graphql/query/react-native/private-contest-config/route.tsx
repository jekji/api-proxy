...
/**
:method: POST
:path: /graphql/query/react-native/private-contest-config
...
export async function POST(request: Request) {
	...
	if (process.env.WWW_GRAPHAL_URL) {
		...
		try {
			const apiURL = process.env.WWW_GRAPHAL_URL + "/graphql/query/react-native/private-contest-config";
			...
			console.log("private-contest-config", JSON.stringify(data));
